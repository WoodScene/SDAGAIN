...
def Time_mean(select_diease_id,missing_rate,year):
    print(year)

    file_name = "Mean_time_" + str(missing_rate) + "_" + disease_list[select_diease_id] + ".csv"
...
def Spatial_mean(select_diease_id,missing_rate,year):
    print(year)

    file_name = "Mean_spatial_" + str(missing_rate) + "_" + disease_list[select_diease_id] + ".csv"
...
if __name__=='__main__':
    ...
    for disease_id2 in range(len(disease_list)):
        for missing_rate in missing_rate_list:
            Time_mean(disease_id2,missing_rate,begin_year)
            Spatial_mean(disease_id2,missing_rate,begin_year)
            #sys.exit(1)